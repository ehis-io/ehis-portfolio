...
const projects = [
  {
    ...
    stack: ['NestJS', 'Python', 'AI', 'GCP', 'Docker'],
    imageUrl:
  ...
  },
  {
    ...
    stack: ['NestJS', 'PostgreSQL', 'JWT', 'OAuth', 'WebSockets', 'BullMQ'],
    imageUrl:
...

  {
    ...
    stack: ['Flutter', 'Go', 'Tailwind', 'REST API'],
    imageUrl:
  ...
  },
  {
    ...
    stack: ['AI', 'SaaS', 'Flutter', 'Firebase'],
    imageUrl:
  ...
  },
  {
    ...
    stack: ['NestJS', 'WebSockets', 'Redis', 'REST API', 'JWT', 'OAuth'],
    imageUrl:
